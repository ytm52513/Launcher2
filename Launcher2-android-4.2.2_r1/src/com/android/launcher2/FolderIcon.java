...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        icon.mPreviewBackground.setImageResource(R.drawable.portal_ring_inner_holo);
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
        ...
        float totalScale = 0.4f;//mBaselineIconScale * scale;
        ...
        float intervalW = (mAvailableSpaceInPreview - (sqrtNum * totalScale * mIntrinsicIconSize)) / sqrtNum;
        float intervalH = (mAvailableSpaceInPreview - (sqrtNum * totalScale * mIntrinsicIconSize)) / sqrtNum;
//        Log.d("yantm", " mAvailableSpaceInPreview = " + mAvailableSpaceInPreview + " sqrtNum = " + sqrtNum 
//                + " mIntrinsicIconSize = " + mIntrinsicIconSize + " intervalH = " + intervalH);
        transX = length == 9 ? paddingleft + (index % sqrtNum)
                * (totalScale * mIntrinsicIconSize + intervalW)
                : index % sqrtNum == 1 ? mAvailableSpaceInPreview - paddingleft
                        - totalScale * mIntrinsicIconSize : paddingleft
                        + (index % sqrtNum) * (mPreviewBackground.getWidth() + intervalW);

        transY = length == 9 ? paddingtop + (index / sqrtNum)
                * (totalScale * mIntrinsicIconSize + intervalH)
                : index / sqrtNum == 1 ? mAvailableSpaceInPreview - paddingtop
                        - totalScale * mIntrinsicIconSize : paddingtop
                        + (index / sqrtNum) * (mPreviewBackground.getWidth() + intervalH);
